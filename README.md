...
Key buffs, when expired, will pop-up in a row above the action bars. These are the buffs assumed to be easy and quick for a player to reapply as needed. The pop-ups are only visible in the Labyrinth.
